# Markdown-test
Test for converting word file to markdown
...
1. Multivariable Calculus (vector calculus). \[Math 243\]
2. Ordinary Differential Equations. \[Math 245\].
...
1. Apply certain aspects of discrete mathematics (graph theory, modulo math) to solve ECE problems.
2. Apply discrete and continuous probability concepts to ECE problems.
3. Solve linear and nonlinear systems using ODEs and apply them to specific ECE problems.
4. Use Laplace and Fourier analysis to solve linear and nonlinear ECE problems.
5. Model physical systems using PDEs and use separation of variables to solve PDE systems and interpret the solutions.
6. Use fundamental linear algebra techniques to solve ECE problems, including eigenvalues and eigenvectors.
7. Apply concepts of vector calculus to integration over curves and surfaces. Use integral calculus to obtain new types of integrals or transform them into one another.
...
# Assessment Methods that Support Measurement of Student Outcomes
